...
**Aviso importante: esta skill no es lo que su nombre sugiere.**
No es una guía general del App Router de Next.js: es la guía de **integración de PostHog**
(analítica de producto) en aplicaciones con App Router.

**Anime Vault no usa PostHog.** Es un vault personal y privado; no hay analítica de terceros,
y añadirla obligaría además a tocar la CSP (`connect-src`) documentada en
`.claude/rules/security.md`.

Se conserva en el repo por si algún día se decide añadir analítica, pero **hoy no aplica**.
Para trabajo real de App Router usa `nextjs-developer`, `react-expert` y
